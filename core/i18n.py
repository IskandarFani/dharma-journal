UI_TEXT = {
    "ru": {
        ...
        "no_featured_title": "Главный материал ещё не выбран",
        "no_featured_text": "Опубликуйте статью и отметьте её как Featured article в админке.",

        "materials": "Материалы",
        "add_more_articles": "Добавьте больше материалов",
        "add_more_articles_text": "Опубликованные статьи появятся здесь автоматически.",
        ...
        "issue_title": "О внимании и присутствии",
        "issue_text": "Материалы о практике, культуре и повседневной Дхарме.",
        ...
        "subscribe_success": "Спасибо. Email добавлен в список подписки.",
        "subscribe_already_exists": "Этот email уже есть в списке подписки.",
        "subscribe_error": "Проверьте email и попробуйте ещё раз.",

        "related": "Похожие материалы",
        "no_related": "Похожие материалы пока не добавлены.",
    ...
    "en": {
        ...
        "no_featured_text": "Publish an article and mark it as Featured article in the admin panel.",

        "materials": "Materials",
        "add_more_articles": "Add more articles",
        "add_more_articles_text": "Published articles will appear here automatically.",
        ...
        "issue_title": "On attention and presence",
        "issue_text": "Articles on practice, culture, and everyday Dharma.",
        ...
        "subscribe_success": "Thank you. Your email has been added to the subscription list.",
        "subscribe_already_exists": "This email is already on the subscription list.",
        "subscribe_error": "Please check your email and try again.",

        "related": "Related articles",
        "no_related": "No related articles yet.",
    ...
    "lt": {
        ...
        "featured": "Pagrindinis tekstas",
        "no_featured_title": "Pagrindinis tekstas dar nepasirinktas",
        "no_featured_text": "Paskelbkite straipsnį ir pažymėkite jį kaip Featured article administravimo skydelyje.",

        "materials": "Medžiaga",
        "add_more_articles": "Pridėkite daugiau tekstų",
        "add_more_articles_text": "Paskelbti straipsniai čia atsiras automatiškai.",
        ...
        "issue_title": "Apie dėmesį ir buvimą",
        "issue_text": "Tekstai apie praktiką, kultūrą ir kasdienę Dharmą.",
        "read_issue": "Skaityti numerį",

        "subscription": "Prenumerata",
        "subscribe_title": "Gauti naujus tekstus",
        "email_placeholder": "Jūsų el. paštas",
        "subscribe_button": "Prenumeruoti",
        "subscribe_success": "Ačiū. El. paštas įtrauktas į prenumeratos sąrašą.",
        "subscribe_already_exists": "Šis el. paštas jau yra prenumeratos sąraše.",
        "subscribe_error": "Patikrinkite el. paštą ir bandykite dar kartą.",

        "related": "Susiję tekstai",
        "no_related": "Susijusių tekstų kol kas nėra.",
...
def get_about_content(language="ru"):
    return ABOUT_CONTENT.get(language, ABOUT_CONTENT["ru"])